...
public final class ResourceBundleUtil {
	...
	public static String getString(String propertyFileName, String propertyName) {
		return ResourceBundle.getBundle(propertyFileName).getString(propertyName);
	}
	...
	public static Long getLong(String propertyFileName, String propertyName) {
		try {
			return Long.parseLong(ResourceBundle.getBundle(propertyFileName).getString(propertyName));
		} catch (Exception ex) {
			return new Long(0L);
		}
	}
	...
	public static Integer getInteger(String propertyFileName, String propertyName) {
		try {
			return Integer.parseInt(ResourceBundle.getBundle(propertyFileName).getString(propertyName));
		} catch (Exception ex) {
	 ...
	 * @return
	 */
	public static Short getShort(String propertyFileName, String propertyName) {
		try {
			return Short.parseShort(ResourceBundle.getBundle(propertyFileName).getString(propertyName));
		} catch (Exception ex) {
	 ...
	 * @return
	 */
	public static Boolean getBoolean(String propertyFileName, String propertyName) {
		try {
			return Boolean.parseBoolean(ResourceBundle.getBundle(propertyFileName).getString(propertyName));
		} catch (Exception ex) {
			return null;
		}
	}
